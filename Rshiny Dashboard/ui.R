...
vars <- c(
  'Collision Vehicle 1' = 'vehicle_type_code1',
  'Collision Vehicle 2' = 'vehicle_type_code2',
  "Injuries" = "number_of_persons_injured",
  "Deaths" = "number_of_persons_killed"
)
                   ...
                   tabPanel("Interactive map",
                            div(class="outer",
                                ...
                                absolutePanel(id = "controls", class = "panel panel-default", fixed = TRUE,
                                              ...
                                              selectInput("vehicle", "Show Just One Vehicle", vars3, selected = ''),
                                              selectInput("daytime", "Select time of day", vars5, selected = '')
                                ),
